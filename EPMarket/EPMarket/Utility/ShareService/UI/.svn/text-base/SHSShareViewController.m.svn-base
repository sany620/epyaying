...
{
    //[OAuthInfo logout];
    UIActionSheet *actionSheet=[[UIActionSheet alloc] initWithTitle:@"与您的亲朋好友、粉丝团分享吧！" delegate:self cancelButtonTitle:nil destructiveButtonTitle:nil otherButtonTitles: nil];
